                              ...
                              !authProvider.isPhoneNumberVerificationButtonLoading
                                  ? CustomButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        } else if (Provider.of<SplashProvider>(context, listen: false).configModel.emailVerification && EmailChecker.isNotValid(_email)) {
                                          ...
                                          if (Provider.of<SplashProvider>(context, listen: false).configModel.emailVerification) {
                                            authProvider.checkEmail(_email).then((value) async {
                                              if (value.isSuccess) {
                                                ...
                                                //todo remove mobile verification
                                                if (false/*value.message == 'active'*/) {
